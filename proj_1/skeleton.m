...
for i = 1:length(labels_true)
    if labels_true(1,i) == 1
        total_positive = total_positive + 1;
        
        if labels_true(1,i) == labels_pred(i,1)
            correct_positive = correct_positive + 1;
        end
        
    end
    
    if labels_true(1,i) == 0
        total_negative = total_negative + 1;
        
        if labels_pred(i,1) == 1
            incorrect_negative = incorrect_negative + 1;
        end
        
    end
end
 
P_D  = correct_positive / total_positive;
P_FA = incorrect_negative / total_negative ;
